...
* Depends on Boost Circular Buffer. I was too lazy to separate that dependency, included entire Boost. For performance purposes such a buffer should be included for something with less latency (very much achievable).
